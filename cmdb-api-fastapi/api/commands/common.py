...
from api.commands import with_appcontext
...
def db_setup():
    """create tables
    """
    # ensure all models are registered on the metadata before create_all
    import api.models.acl  # noqa
    import api.models.cmdb  # noqa
    import api.models.common_setting  # noqa
