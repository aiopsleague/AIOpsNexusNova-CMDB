...
@router.get("/auth_with_token")
@router.get("/req_token")
@auth_with_app_token
def auth_with_token_view_get():
...
@router.post("/auth_with_token")
@router.post("/req_token")
@args_required("token")
@auth_with_app_token
def auth_with_token_view_post():
