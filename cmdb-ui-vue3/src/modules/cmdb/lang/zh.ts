...
if __name__ == "__main__":
    ...
    if isinstance(result, list):
        ...
        execLogTypes: '记录类型',
        clearLog: '清除日志',
        confirmClearLog: '确认清除当前类型的所有执行历史日志？',
        clearLogSuccess: '日志已清除',
    ...
    ci: {
        ...
        grafana: '监控',
        monitoring: '监控',
        grafanaNoDashboard: '未找到关联的监控仪表板',
        grafanaNotConfigured: '尚未配置监控，请先在后台管理中配置',
        monitoringNoDashboard: '未找到关联的监控仪表板',
        monitoringNotConfigured: '尚未配置监控，请先在后台管理中配置',
        grafanaConnectionError: 'Grafana 连接异常',
        grafanaConnectionErrorDesc: '无法连接到 Grafana 实例，监控仪表盘暂时不可用',
        grafanaConnectionRetry: '重试',
        ...
        alertValue: '当前值',
        prometheusConnectionError: 'Prometheus 连接异常',
        prometheusConnectionErrorDesc: '部分 Prometheus 连接实例无法访问，告警数据可能不完整',
        prometheusConnectionHealthy: '连接正常',
        prometheusConnectionUnhealthy: '连接异常',
        prometheusConnectionRetry: '重试',
        alertDurationDay: '天',
        alertDurationHour: '时',
        alertDurationMinute: '分',
        alertDurationSecond: '秒',
        alertFilteredBy: '当前筛选',
        alertClearFilter: '清除筛选',
        alertNoMatchFilter: '当前筛选条件下无告警 — 点击"活跃告警"查看全部',
        topo: '拓扑',
        table: '表格',
