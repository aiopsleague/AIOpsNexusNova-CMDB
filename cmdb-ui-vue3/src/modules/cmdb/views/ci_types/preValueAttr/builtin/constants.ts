...
export const DISPLAY_VALUE_SELECT: DisplayValueOption[] = [
...
export interface UserFilterSelectOption {
  label: string
  value: string
  is_choice?: boolean
  choice_value?: Array<{ label: string; value: string | number }>
}

export const USER_FILTER_SELECT: UserFilterSelectOption[] = [
  { label: 'cs.companyStructure.nickname', value: 'nickname' },
  ...
  },
  {
    ...
    choice_value: [
      ...
      { label: 'cs.companyStructure.undergraduate', value: '本科' },
