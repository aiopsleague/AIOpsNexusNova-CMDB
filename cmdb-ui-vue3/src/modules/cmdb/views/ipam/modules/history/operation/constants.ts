// IPAM history operation constants (migrated from `history/operation/constants.js`).
...
export const OPERATE_TYPE_TEXT: Record<string, string> = {
...
export const OPERATE_TYPE_COLOR: Record<string, { color: string; backgroundColor: string }> = {
