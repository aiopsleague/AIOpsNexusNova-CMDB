...
const componentMap: Record<string, () => Promise<unknown>> = {
  ...
  cmdbTreeViews: () => import('@/modules/cmdb/views/tree_views/index.vue'),
  cmdbResourceSearch: () => import('@/modules/cmdb/views/resource_search_2/index.vue'),
  cmdbDiscoveryCI: () => import('@/modules/cmdb/views/discoveryCI/index.vue'),
  ...
  cmdbPreference: () => import('@/modules/cmdb/views/preference/index.vue'),
  cmdbBatch: () => import('@/modules/cmdb/views/batch/index.vue'),
  ...
  cmdbPreferenceRelation: () => import('@/modules/cmdb/views/preference_relation/index.vue'),
