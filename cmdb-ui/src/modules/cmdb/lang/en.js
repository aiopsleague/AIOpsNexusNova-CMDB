const cmdb_en = {
    ...
    ciType: {
        ...
        fileDragHint: 'Any file type, max',
...
if __name__ == "__main__":
    ...
    if isinstance(result, list):
        ...
        clearLog: 'Clear Logs',
        confirmClearLog: 'Confirm to clear all execution history logs for this type?',
        clearLogSuccess: 'Logs cleared',
    ...
    ci: {
        ...
        grafanaNoDashboard: 'No associated monitoring dashboard found',
        grafanaNotConfigured: 'Monitoring is not configured. Please configure it in System Settings first',
        monitoringNoDashboard: 'No associated monitoring dashboard found',
        monitoringNotConfigured: 'Monitoring is not configured. Please configure it in System Settings first',
        grafanaConnectionError: 'Grafana Connection Error',
        grafanaConnectionErrorDesc: 'Cannot connect to the Grafana instance. Monitoring dashboard is temporarily unavailable',
        grafanaConnectionRetry: 'Retry',
        prometheusAlerts: 'Prometheus Alerts',
        alerts: 'Alerts',
        alertFiring: 'Firing',
        alertDisaster: 'Disaster',
        ...
        alertConnectionFailed: 'Unable to fetch alert data. Please check if Prometheus connection instances are healthy',
        ...
        prometheusConnectionError: 'Prometheus Connection Error',
        prometheusConnectionErrorDesc: 'Some Prometheus connection instances are unreachable. Alert data may be incomplete',
        prometheusConnectionHealthy: 'Connection Healthy',
        prometheusConnectionUnhealthy: 'Connection Unhealthy',
        prometheusConnectionRetry: 'Retry',
        alertDurationDay: 'd',
        alertDurationHour: 'h',
        alertDurationMinute: 'm',
        alertDurationSecond: 's',
        alertFilteredBy: 'Filtered by',
        alertClearFilter: 'Clear filter',
        alertNoMatchFilter: 'No alerts matching current filter — click "Firing" to view all',
        topo: 'Topology',
        table: 'Table',
