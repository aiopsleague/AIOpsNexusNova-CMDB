const cs_en = {
  ...
  prometheus: {
    ...
    displayColumnsHint: 'Configure which labels/annotations appear as table columns. Set column titles for each language.',
    columnKey: 'Key',
    columnKeyPlaceholder: 'Prometheus label key',
    columnTitleZh: '中文名称',
