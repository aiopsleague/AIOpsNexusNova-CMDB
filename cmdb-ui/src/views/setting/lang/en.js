const cs_en = {
  menu: {
    ...
    fileStorageStorage: 'File Storage Settings',
    fileStoragePreview: 'File Preview Settings',
  ...
  grafana: {
    ...
    grafanaVar: 'Grafana Variable',
    ciAttr: 'CI Attribute',
    addVarMapping: 'Add Variable Mapping',
    dashboardNameRequired: 'Please select or input dashboard name',
    varMappingIncomplete: 'Some variable mapping rows are incomplete',
    dashboardLoadFailed: 'Failed to load dashboards, you can input the name manually',
    testConnect: 'Test Connection',
    ...
    urlRequired: 'Please enter Grafana URL',
    apiKeyRequired: 'Please enter API Key',
    apiKeyKeepTip: 'Leave blank to keep unchanged',
    ciTypeRequired: 'Please select CI type',
    connectionRequired: 'Please select connection',
    operation: 'Operation',
    edit: 'Edit',
    delete: 'Delete',
    source: 'Source',
    ...
    filterRulesOptional: 'Optional, matches all CIs of this type if not configured',
    filterLogic: 'Logic',
    filterLogicAnd: 'AND (all match)',
    filterLogicOr: 'OR (any match)',
    filterField: 'Attribute',
    filterValue: 'Value',
    filterAddCondition: 'Add Condition',
    filterSummary: '{count} condition(s) configured',
    op_equal: 'Equal',
  ...
  prometheus: {
    ...
    addLabelMapping: 'Add Label',
    promLabel: 'Prom Label',
    ciAttr: 'CI Attribute',
    ...
    ciTypeRequired: 'CI type is required',
    connectionRequired: 'Connection is required',
    labelMappingIncomplete: 'Label mapping is incomplete, please fill in all required fields',
    displayColumns: 'Display Columns',
    displayColumnsHint: 'Configure columns to display. Use labels.xxx or annotations.xxx prefix to specify source. Without prefix, labels is checked first then annotations.',
    columnKey: 'Key',
    columnKeyPlaceholder: 'e.g. labels.alertname, annotations.summary',
    columnTitleZh: '中文名称',
    columnTitleEn: 'English Title',
    addDisplayColumn: 'Add Column',
  ...
  fileStorage: {
    ...
    localPathPlaceholder: 'Enter local storage path',
    ...
    s3Region: 'Region',
    s3UseSSL: 'Use SSL',
    secretKeyKeepTip: 'Leave blank to keep unchanged',
    testConnection: 'Test Connection',
    testSuccess: 'Connection test succeeded',
    testFailed: 'Connection test failed',
    allowedExtensions: 'Allowed Extensions',
    allowedExtensionsPlaceholder: 'Enter extension and press Enter, e.g. pdf, docx',
  ...
  filePreview: {
    basicConfig: 'Preview Configuration',
    previewServerUrl: 'Preview Server URL',
    previewServerUrlPlaceholder: 'Enter the kkFileView server URL, e.g. http://127.0.0.1:8012/onlinePreview',
    forceUpdatedCacheTypes: 'Force Updated Cache Types',
    forceUpdatedCacheTypesPlaceholder: 'Enter extension and press Enter, e.g. txt, md',
    testConnection: 'Test Connection',
    testSuccess: 'Connection test succeeded',
    testFailed: 'Connection test failed',
    fieldRequired: 'This field is required',
