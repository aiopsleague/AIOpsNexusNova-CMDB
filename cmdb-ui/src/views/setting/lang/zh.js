const cs_zh = {
  menu: {
    ...
    fileStorage: '存储设置',
    fileStorageStorage: '文件存储设置',
    fileStoragePreview: '文件预览设置',
    authority: '权限管理',
    sys: '系统角色',
    technician: '技术员角色',
    user: '用户角色',
  ...
  grafana: {
    ...
    varTypeNative: '原生变量',
    filterRules: '过滤条件',
    filterRulesOptional: '可选，不配置则匹配该类型所有CI',
    filterLogic: '组合逻辑',
    filterLogicAnd: 'AND（全部满足）',
    filterLogicOr: 'OR（任一满足）',
    filterField: '属性字段',
    filterValue: '匹配值',
    filterAddCondition: '添加条件',
    filterSummary: '已配置{count}个过滤条件',
    op_equal: '等于',
    op_not_equal: '不等于',
    op_contains: '包含',
    op_not_contains: '不包含',
  ...
  prometheus: {
    ...
    connectionInstance: '连接实例',
    labelMapping: '标签映射',
    addLabelMapping: '添加标签',
    promLabel: 'Prometheus标签',
    ciAttr: 'CI属性',
    fixedValue: '固定值',
    mapType: '映射类型',
    field: '字段',
    ...
    nameRequired: '名称不能为空',
    urlRequired: '地址不能为空',
    ciTypeRequired: 'CI类型不能为空',
    connectionRequired: '连接实例不能为空',
    labelMappingIncomplete: '标签映射不完整，请填写所有必填字段',
    displayColumns: '显示列',
    displayColumnsHint: '配置在告警表格中显示的列。键支持 labels.xxx / annotations.xxx 前缀指定来源，不加前缀时先从labels查找再从annotations查找',
    columnKey: '键',
    columnKeyPlaceholder: '例: labels.alertname, annotations.summary',
    columnTitleZh: '中文名称',
    columnTitleEn: '英文名称',
    addDisplayColumn: '添加列',
  ...
  fileStorage: {
    ...
    local: '本地存储',
    localPath: '存储路径',
    localPathPlaceholder: '请输入本地存储路径',
    s3Endpoint: 'S3服务地址',
    ...
    s3Region: 'Region',
    s3UseSSL: '使用SSL',
    secretKeyKeepTip: '留空则不修改',
    testConnection: '测试连接',
    testSuccess: '连接测试成功',
    testFailed: '连接测试失败',
    allowedExtensions: '允许的文件类型',
    allowedExtensionsPlaceholder: '输入扩展名后回车，如 pdf、docx',
  ...
  filePreview: {
    basicConfig: '预览配置',
    previewServerUrl: '预览服务地址',
    previewServerUrlPlaceholder: '请输入 kkFileView 服务地址，如 http://127.0.0.1:8012/onlinePreview',
    forceUpdatedCacheTypes: '强制更新缓存类型',
    forceUpdatedCacheTypesPlaceholder: '输入扩展名后回车，如 txt、md',
    testConnection: '测试连接',
    testSuccess: '连接测试成功',
    testFailed: '连接测试失败',
    fieldRequired: '此项为必填',
